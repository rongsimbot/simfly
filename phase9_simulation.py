...
# Add code roots — ensure CODE_ROOT comes first (remove cwd shadowing)
if '' in sys.path:
    sys.path.remove('')
for d in [CODE_ROOT, SENSORY_DIR, FLYWIRE_DIR]:
...
class BridgeAwareClosedLoop(ClosedLoop):
    ...
    def __init__(self, bridge: DNtoMNbridge, loader, *args, **kwargs):
